...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        if(grid[0][0]==grid[1][0]&& grid[1][0]==grid[2][0] && grid[1][0]=='x'
              || grid[0][1]==grid[1][1] && grid[1][1]==grid[2][1] && grid[1][1]=='x'
              ||grid[0][2]==grid[1][2] && grid[1][2]==grid[2][2] &&  grid[1][2]=='x'
              ||grid[0][0]==grid[1][1] && grid[1][1]==grid[2][2] && grid[1][1]=='x'
              ||grid[0][2]==grid[1][1] && grid[1][1]==grid[2][0] && grid[1][1]=='x'
              ||grid[0][0]==grid[0][1]&& grid[0][1]==grid[0][2] && grid[0][1]=='x'
              ||grid[1][0]==grid[1][1]&& grid[1][1]==grid[1][2] && grid[1][1]=='x'
              ||grid[2][0]==grid[2][1]&& grid[2][1]==grid[2][2] && grid[2][1]=='x') {
            result = "X Wins";
        }
        else if(grid[0][0]==grid[1][0]&& grid[1][0]==grid[2][0] && grid[1][0]=='o'
                || grid[0][1]==grid[1][1] && grid[1][1]==grid[2][1] && grid[1][1]=='o'
                ||grid[0][2]==grid[1][2] && grid[1][2]==grid[2][2] &&  grid[1][2]=='o'
                ||grid[0][0]==grid[1][1] && grid[1][1]==grid[2][2] && grid[1][1]=='o'
                ||grid[0][2]==grid[1][1] && grid[1][1]==grid[2][0] && grid[1][1]=='o'
                ||grid[0][0]==grid[0][1]&& grid[0][1]==grid[0][2] && grid[0][1]=='o'
                ||grid[1][0]==grid[1][1]&& grid[1][1]==grid[1][2] && grid[1][1]=='o'
                ||grid[2][0]==grid[2][1]&& grid[2][1]==grid[2][2] && grid[2][1]=='o') {
            result = "O Wins!";
        }
        if(freeSpots == 0)
            result ="TIE : Common Guys!! You can do better!!";
        return result;
    }
